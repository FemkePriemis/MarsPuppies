...
namespace PuppyAPI.Migrations
{
    ...
    [Migration("20230316164624_Add1to1BehaviourDog")]
    partial class Add1to1BehaviourDog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PuppyAPI.Database.EFmodels.EFBehaviour", b =>
                {
                    b.HasOne("PuppyAPI.Database.EFmodels.EFDog", "EFDog")
                        .WithMany()
                        .HasForeignKey("EFDogId")
